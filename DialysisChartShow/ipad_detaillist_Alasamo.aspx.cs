...
{
    public partial class ipad_detaillist_Alasamo : BaseForm
    {
        ...
        protected void Show()
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                Common.SetComboBoxValue(cbo_mechine_model2, cln1_col4, false);//透析器型号2
            ...
            else
            {
                ...
                if (row["cln1_col4"].ToString() == "")
                    ...
                    Common.SetComboBoxValue(cbo_mechine_model2, row["cln1_col4"].ToString(), false);//透析器型号2
                ...
                TextField7.EmptyText = dt.Rows[0]["cln1_col16"].ToString().Replace("h", ""); //提示透析時間
        ...
        protected void GetComboxData()
        {
            ...
            Common.SetComboBoxItem(cbo_mechine_model2, dt1, true, "NAME", "CODE");
        ...
        protected void Show_TPRBP()
        {
            try
            {
                String sql = "SELECT a.dialysis_date, a.dialysis_time, a.column_7, a.column_6, a.column_2 AS column_3, a.column_10, a.column_8, a.column_4, ";
        ...
        protected void ImageBtn_save1_Click(object sender, DirectEventArgs e)
        {
            ...
            else
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    sql += "     a.cln1_col4 = '" + Common.GetComboBoxText(cbo_mechine_model2) + "',"; //透析器型号2
                ...
                else
                {
                    ...
                    //Hospital_Alasamo
                    sql += "cln1_user,cln1_dateadded) ";
                    sql += "VALUES('" + patient_id.Text + "','" + info_date1.Text + "','";
                    sql += Common.GetComboBoxText(cbo_mechine_model2) + "','" + bedno.Text + "','" + machine_type.Text + "','" + hpack.Text + "','" + txt_weight_before.Text + "','";
                ...
                sql = "UPDATE pat_info " +
                         "SET pif_hpack='" + Common.GetComboBoxValue(cbo_h_type) + "', " + 
                             ...
                             "pif_hpack4='" + Common.GetComboBoxValue(cbo_mechine_model2) + "' " + 
                ...
                sql = "UPDATE pat_visit " +
                         "SET pv_macno='" + Common.GetComboBoxValue(cbo_dialysis_type) + "', " +
                             ...
                             "pv_hpack4='" + Common.GetComboBoxValue(cbo_mechine_model2) + "' " +
        ...
        protected void Btn_detail01_Click(object sender, DirectEventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                string sURL = "ipad_history_Alasamo.aspx";
        ...
        protected void CheckType()
        {
            ...
            {
                cbo_mechine_model2.ReadOnly = false;
            }
            else
            {
                cbo_mechine_model2.ReadOnly = true;
                cbo_mechine_model2.Select(0);
            }
        }
    }
}