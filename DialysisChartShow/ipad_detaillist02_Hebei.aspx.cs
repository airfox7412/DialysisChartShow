...
{
    public partial class ipad_detaillist02_Hebei : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!X.IsAjaxRequest)
            {
                ...
                txt_htype.Text = Request.QueryString["hpack"];
                ...
                if (patient_name.Text == null)
                {
                    ...
                    txt_htype.Text = Request.QueryString["amp;hpack"];
                    hpack.Text = Request.QueryString["amp;hpack"];
        ...
        protected void Show()
        {
            ...
            string sql = "SELECT a.cln1_col11, a.cln1_col12, a.cln1_col4, a.cln1_col33, a.cln1_col35, a.cln1_col36, b.* FROM clinical1_nurse a ";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txt_htype.Text = dt.Rows[0]["cln1_col4"].ToString();
            }
            dt.Dispose();
        }
        ...
        protected void Btn_detail_Click(object sender, DirectEventArgs e)
        {
            ...
            string sURL = "ipad_detaillist_Hebei.aspx";
            X.Redirect(sURL + "?patient_id=" + patient_id.Text +
                                    "&patient_name=" + patient_name.Text +
                                    "&machine_type=" + machine_type.Text +
                                    "&mechine_model=" + mechine_model.Text +
