<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_detaillist_Suzhou.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_detaillist_Suzhou" %>
            ...
            <Items>
                ...
                <ext:Container ID="Container21" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>          	    
                        ...
                        <ext:TextField ID="TextField13" runat="server" FieldLabel="上机者" ReadOnly="true" LabelWidth="80" LabelAlign="Right" PaddingSpec="10 10 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                        ...
                        <ext:TextField ID="TextField131" runat="server" FieldLabel="核對者" ReadOnly="true" LabelWidth="80" LabelAlign="Right" PaddingSpec="10 10 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                        ...
                        <ext:TextField ID="TextField24" runat="server" FieldLabel="下机者" ReadOnly="true" LabelWidth="80" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                ...
                <ext:Container ID="Container22" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:TextField ID="TextField14" runat="server" FieldLabel="用药核对护士" ReadOnly="true" LabelWidth="170" ColumnWidth=".34" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                    ...
                    <Items>
                        ...
                        <ext:Container ID="Container28" runat="server" Layout="HBoxLayout">
                            <Items> 
                                ...
                                <ext:TextField ID="TextFieldTime" runat="server" FieldLabel="紀錄時間" LabelWidth="110" ColumnWidth=".2" LabelAlign="Right" PaddingSpec="10 50 0 2" ReadOnly="false" Flex="1" />
                            </Items> 
                        </ext:Container>
