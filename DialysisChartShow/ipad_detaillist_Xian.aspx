<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_detaillist_Xian.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_detaillist_Xian" %>
            ...
            <Items>
                ...
                <ext:Container ID="Container5" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="SelectBox10" runat="server" FieldLabel="抗凝剂" LabelWidth="160" LabelAlign="Right" ColumnWidth=".5" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                ...
                <ext:Container ID="Container6" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:TextField ID="TextCln1_col35" runat="server" FieldLabel="" ColumnWidth=".5" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" Flex="1" in>
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                ...
                <ext:Container ID="Container7" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:TextField ID="TextFirst" runat="server" FieldLabel="首次剂量" ColumnWidth=".5" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                ...
                <ext:Container ID="Container8" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:TextField ID="TextAdd" runat="server" FieldLabel="追加量" ColumnWidth=".5" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                        <ext:TextField ID="TextAmount" runat="server" FieldLabel="超滤总量" ColumnWidth=".5" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                ...
                <ext:Container ID="Container10" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:TextField ID="TextReplaceAmount" runat="server" FieldLabel="置换量" ColumnWidth=".48" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                        <ext:Label ID="LabelSpace4" runat="server" Text="" ColumnWidth=".52" PaddingSpec="10 2 2 2" Cls="label2" Flex="1" />
                    </Items> 
                </ext:Container>
                ...
                <ext:Container ID="Container14" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="SelectBoxEPO" runat="server" FieldLabel="" ColumnWidth=".2" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="u" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                        ...
                        <ext:SelectBox ID="SelectBoxLcard" runat="server" FieldLabel="" ColumnWidth=".2" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="g" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                ...
                <ext:Container ID="Container15" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="SelectBoxIron" runat="server" FieldLabel="" ColumnWidth=".2" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="ug" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                ...
                <ext:Container ID="Container16" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="SelectBoxCalcitriol" runat="server" FieldLabel="" ColumnWidth=".2" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="ml" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                        ...
                        <ext:SelectBox ID="SelectBoxSodium" runat="server" FieldLabel="" ColumnWidth=".2" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="mmol/L" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                        <%--<ext:Label ID="LabelSpace5" runat="server" Text="" ColumnWidth=".1" PaddingSpec="10 2 2 2" Cls="label2" Flex="1" />--%>
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container17" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="SelectBoxPotassium" runat="server" FieldLabel="" ColumnWidth=".1" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="mmol/L" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                        <ext:Label ID="LabelSpace6" runat="server" Text="  " ColumnWidth=".5" PaddingSpec="10 2 2 2" Cls="label2" Flex="1" />
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container21" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>          	    
                        <ext:TextField ID="TextField12" runat="server" FieldLabel="穿刺者" ReadOnly="true" LabelWidth="120" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                        ...
                        <ext:TextField ID="TextField13" runat="server" FieldLabel="治疗护士" ReadOnly="true" LabelWidth="120" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                ...
                <ext:Container ID="Container22" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:TextField ID="TextField131" runat="server" FieldLabel="核對者" ReadOnly="true" LabelWidth="120" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                ...
                <ext:Panel ID="Panel1" runat="server" ButtonAlign="Center" ColumnWidth="1" Layout="AnchorLayout" Title="净化过程明细" BodyStyle="background-color:#EBF5FF !important;">
                    <Items>
                        ...
                        <ext:Container ID="Container25" runat="server" Layout="HBoxLayout">
                            <Items> 
                                <ext:TextField ID="TextField_7" runat="server" FieldLabel="电导" LabelWidth="100" ColumnWidth=".33" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1" />
                                ...
                                <ext:TextField ID="TextField_3" runat="server" FieldLabel="超滤率" LabelWidth="100" ColumnWidth=".34" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="ml/hr" Flex="1" />
                            </Items> 
                        </ext:Container>
                        <ext:Container ID="Container26" runat="server" Layout="HBoxLayout">
                            <Items> 
                                <ext:TextField ID="TextField_10" runat="server" FieldLabel="超滤量" LabelWidth="100" ColumnWidth=".33" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="ml" Flex="1" />
                        ...
                        <ext:Container ID="Container28" runat="server" Layout="HBoxLayout">
                            <Items> 
                                ...
                                <ext:TextField ID="TextField21" runat="server" FieldLabel="记录人**" LabelWidth="110" ColumnWidth=".5" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="red" ReadOnly="true" Flex="1">
                                    <DirectEvents>
                                        <Focus OnEvent="text_click" />
                                    </DirectEvents>
                                </ext:TextField>
                ...
                <ext:GridPanel ID="Grid_Show_TPRBP" runat="server" Title="净化明细" Margins="0 0 5 5" ColumnWidth="1" >
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column_10" runat="server" DataIndex="column_10" Text="超滤量" Width="80" />
