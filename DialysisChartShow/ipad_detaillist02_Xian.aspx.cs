...
{
    public partial class ipad_detaillist02_Xian : System.Web.UI.Page
    {
        ...
        protected void Show()
        {
            ...
            //string sql = "SELECT a.cln1_col11, a.cln1_col12, a.cln1_col4, a.cln1_col33, a.cln1_col36, b.* FROM clinical1_nurse a ";
            string sql = "SELECT a.cln1_col11, a.cln1_col12, a.cln1_col4, a.cln1_col33, a.cln1_col21, b.* FROM clinical1_nurse a ";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                mechine_model.Text = dt.Rows[0]["cln1_col4"].ToString();
                ...
                TextField10.Text = dt.Rows[0]["cln1_col21"].ToString(); // 淨化小結的用藥護士為淨化紀錄的治療護士
            }
            dt.Dispose();
        }
        ...
        protected void show_time()
        {
            ...
            string sql = "SELECT cast(a.cln1_col5 as DECIMAL(6,1))-cast(a.cln1_col8 as DECIMAL(6,1)) column_2 ";
