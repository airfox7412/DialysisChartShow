...
{
    public partial class ipad_detaillist_Henan : BaseForm
    {
        public string toDay = DateTime.Now.ToString("yyyy-MM-dd");
        public string sTIME="";

        string cln1_col1, cln1_col3, cln1_col6, cln1_col10, cln1_col13, cln1_col14, cln1_col15, cln1_col17, cln1_col18, cln1_col19;
        ...
        protected void Show()
        {
            ...
            if (dt0.Rows.Count > 0)
            {
                ...
                cln1_col4 = dt0.Rows[0]["cln1_col4"].ToString(); //透析器型号2
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                Common.SetComboBoxValue(cbo_hpack4, cln1_col4, false);//透析器型号2
            ...
            else
            {
                ...
                if (row["cln1_col4"].ToString() == "")
                    Common.SetComboBoxValue(cbo_hpack4, cln1_col4, false);//透析器型号2
                else
                    Common.SetComboBoxValue(cbo_hpack4, row["cln1_col4"].ToString(), false);//透析器型号2
                ...
                string tube_model2 = Common.get_tube_model(row, "cln1_col47");
                if (tube_model != null)
                    Common.SetComboBoxValue(cbo_hpack5, tube_model2, false); //管路型号2
                ...
                TextField11.Text = dt.Rows[0]["cln1_col37"].ToString(); //置換量

                if (Session["USER_RIGHT"].ToString() == "NU")
                {
                    if (TextField13.Text == "")
                    {
                        TextField13.Text = Session["USER_NAME"].ToString();
                    }
                    if (TextField24.Text == "")
                    {
                        TextField24.Text = Session["USER_NAME"].ToString();
                    }
                    if (TextField25.Text == "")
                    {
                        TextField25.Text = Session["USER_NAME"].ToString();
                        Update_DrugTime(TextField25.Text);
                    }
                    if (TextField21.Text == "")
                    {
                        TextField21.Text = Session["USER_NAME"].ToString();
                    }
                }
        ...
        protected void GetComboxData()
        {
            ...
            //Common.SetComboBoxValue(cbo_hpack4, mechine_model.Text, true); //透析器型號2
            Common.SetComboBoxValue(cbo_hpack3, hpack3.Text, true); //管路型号
            //Common.SetComboBoxValue(cbo_hpack5, hpack3.Text, true); //管路型号2
        }
        #endregion
        ...
        protected void ImageBtn_save1_Click(object sender, DirectEventArgs e)
        {
            ...
            else
            {
                if (TextField5.Text != "")
                {
                    try
                    {
                        DateTime dateTime = DateTime.ParseExact(TextField5.Text, "HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture);
                    }
                    catch
                    {
                        Common._ErrorMsgShow("透析开始时间格式错误，请依 00:00:00 格式输入");
                        return;
                    }
                }
                ...
                if (TextField6.Text != "")
                {
                    try
                    {
                        DateTime dateTime = DateTime.ParseExact(TextField6.Text, "HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture);
                    }
                    catch
                    {
                        Common._ErrorMsgShow("透析結束时间格式错误，请依 00:00:00 格式输入");
                        return;
                    }
                }
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    sql += "     a.cln1_col4 = '" + Common.GetComboBoxText(cbo_hpack4) + "',"; //透析器型号2
                    ...
                    sql += "     a.cln1_col26 = '" + Common.GetComboBoxText(cbo_hpack2) + "', ";
                    sql += "     a.cln1_col33 = '" + TextField23.Text + "',";
                    sql += "     a.cln1_col27 = '" + Common.GetComboBoxText(cbo_hpack3) + "', ";
                    sql += "     a.cln1_col47 = '" + Common.GetComboBoxText(cbo_hpack5) + "', ";
                ...
                else
                {
                    ...
                    sql += "cln1_col26,cln1_col27,cln1_col47,";
                    sql += "cln1_col28,cln1_col29,"; //加上數量
                    sql += "cln1_col33,cln1_col34,cln1_col35,";
                    sql += "cln1_col36,cln1_col37,cln1_user,cln1_dateadded) ";
                    sql += "VALUES('" + patient_id.Text + "','" + info_date1.Text + "','";
                    sql += Common.GetComboBoxText(cbo_hpack4) + "','" + bedno.Text + "','" + machine_type.Text + "','" + hpack.Text + "','" + txt_weight_before.Text + "','";
                    ...
                    sql += "'" + TextField13.Text + "','" + TextField14.Text + "','" + TextArea1.Text + "','" + Common.GetComboBoxText(cbo_Col24) + "','',";
                    sql += "'" + Common.GetComboBoxText(cbo_hpack2) + "','" + Common.GetComboBoxText(cbo_hpack3) + "','" + Common.GetComboBoxText(cbo_hpack5) + "',";
                    //擬用藥 EPO...Value
                    sql += "'','',";
                    //擬用藥
                    sql += "'" + TextField23.Text + "','" + Common.GetComboBoxText(cbo_h_type) + "','" + TextField24.Text + "',";
                    sql += "'" + TextField25.Text + "','" + TextField11.Text + "','','')";
                }
                db.Excute(sql);
                ...
                sql = "UPDATE pat_info " +
                         "SET pif_hpack='" + Common.GetComboBoxValue(cbo_h_type) + "', " + 
                             "pif_hpack2='" + Common.GetComboBoxValue(cbo_hpack2) + "', " +
                             "pif_hpack3='" + Common.GetComboBoxValue(cbo_hpack3) + "', " +
                             "pif_hpack4='" + Common.GetComboBoxValue(cbo_hpack4) + "', " +
                ...
                sql = "UPDATE pat_visit " +
                         "SET pv_macno='" + Common.GetComboBoxValue(cbo_dialysis_type) + "', " +
                             ...
                             "pv_hpack2='" + Common.GetComboBoxValue(cbo_hpack2) + "', " +
                             "pv_hpack3='" + Common.GetComboBoxValue(cbo_hpack3) + "', " +
                             "pv_hpack4='" + Common.GetComboBoxValue(cbo_hpack4) + "', " +
        ...
        protected void CheckcboValue()
        {
            ...
            if (cbo_hpack2.Text.Trim() == "")
            {
                cbo_hpack2.LabelCls = "blink";
            }
            else
            {
                cbo_hpack2.LabelCls = "my-Field";
            }
        }
        ...
        protected void Btn_detail02_Click(object sender, DirectEventArgs e)
        {
            ...
            sURL += "?patient_id=" + patient_id.Text +
                                ...
                                "&bedno=" + bedno.Text +
                                "&floor=" + floor.Text +
                                "&mechine_model=" + cbo_hpack2.SelectedItem.Value +
