<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_detaillist_Hebei.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_detaillist_Hebei" %>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="血液净化记录" ButtonAlign="Center" Padding="5" MonitorResize="true">
            <Items>
                ...
                <ext:Container ID="Container11" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:TextField ID="TextField9" runat="server" FieldLabel="血流速" ColumnWidth=".5" IndicatorText="ml/min" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-red'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                ...
                <ext:Container ID="Container3739" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:TextField ID="TextField37" runat="server" FieldLabel="置换量" IndicatorText="" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:TextField ID="TextField38" runat="server" FieldLabel="透析后凝血" IndicatorText="" LabelWidth="130" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:SelectBox ID="SelectBox39" runat="server" FieldLabel="机器消毒时间" LabelWidth="160" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1" />
                    </Items> 
                </ext:Container>
                    ...
                    <Items>
                        ...
                        <ext:Container ID="Container25" runat="server" Layout="HBoxLayout">
                            <Items> 
                                ...
                                <ext:TextField ID="TextField_3" runat="server" FieldLabel="超滤量" LabelWidth="100" ColumnWidth=".34" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="ml" Flex="1" />
                            </Items> 
                        </ext:Container>
