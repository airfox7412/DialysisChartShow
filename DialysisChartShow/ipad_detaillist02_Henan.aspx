<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_detaillist02_Henan.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_detaillist02_Henan" %>
...
<body>
    ...
    <div>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="净化过程小结(河南人民)" BodyStyle="background-color:#EBF5FF !important;" AutoScroll="true">
            <Items>
                <ext:Container ID="Container00" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:ImageButton ID="Btn_detail02" runat="server" ImageUrl="Styles/detail02over.png" Height="50" Weight="300" Margins="0 0 0 0" Flex="1" >
                            <DirectEvents>
                ...
                <ext:Container ID="Container2" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                            <ext:TextField ID="txt_htype" runat="server" FieldLabel="血管通路类型" LabelCls="formlabel" LabelAlign="Right" LabelWidth="220" 
                ...
                <ext:Container ID="Container99" runat="server" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:ImageButton ID="ImageButton4" runat="server" ImageUrl="Styles/detail02over.png" Height="50" Weight="300" Margins="0 0 0 0" Flex="1" >
                            <DirectEvents>
                                <Click OnEvent="Btn_detail02_Click" />
                            </DirectEvents>
                        </ext:ImageButton>
