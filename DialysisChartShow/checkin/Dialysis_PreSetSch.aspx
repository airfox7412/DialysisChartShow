<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_PreSetSch.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.Dialysis_PreSetSch" %>
...
<body>
    ...
    <div>    
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" ButtonAlign="Center" Padding="5" MonitorResize="true" Title="预约处方模板" Header="false" >            
            <Items>
                        ...
                        <ext:Container ID="Container12" runat="server" ColumnWidth=".8" Layout="FitLayout">
                            <Items>
                                <ext:Container ID="Container2" runat="server" Layout="HBoxLayout">
                                    <Items>
                                        <ext:TextField ID="text_info_date" runat="server" FieldLabel="透析日期" LabelWidth="110" LabelAlign="Right" ColumnWidth=".3" Cls="Text-blue" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                        <ext:TextField ID="TextTimes" runat="server" FieldLabel="透析次数" LabelWidth="100" LabelAlign="Right" ColumnWidth=".3" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                        <ext:TextField ID="floor" runat="server" FieldLabel="楼层" LabelWidth="90" LabelAlign="Right" ColumnWidth=".3" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="Container1" runat="server" Layout="HBoxLayout">
                                    <Items>
                                        <ext:TextField ID="area" runat="server" FieldLabel="床区" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="read_field" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                        <ext:TextField ID="bedno" runat="server" FieldLabel="床号" LabelWidth="100" ColumnWidth=".3" LabelAlign="Right" Cls="read_field" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />                           
                                        <ext:TextField ID="time" runat="server" FieldLabel="时段" LabelWidth="90" ColumnWidth=".3" LabelAlign="Right" Cls="read_field" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                    </Items>
                                </ext:Container>
                                <ext:Container ID="Container3" runat="server" Layout="HBoxLayout">
                                    <Items>
                                        <ext:TextField ID="Tex_Patient_Name" runat="server" FieldLabel="姓名" LabelWidth="110" LabelAlign="Right" Cls="read_field" ColumnWidth=".3" Padding="1" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                        <ext:TextField ID="Tex_Patient_Gender" runat="server" FieldLabel="性别" LabelWidth="100" LabelAlign="Right" Cls="read_field" ColumnWidth=".34" Padding="1" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                        <ext:TextField ID="Tex_Patient_Age" runat="server" FieldLabel="年龄" LabelWidth="90" LabelAlign="Right" Cls="read_field" ColumnWidth=".3" LabelCls="my-Field" ReadOnly="true" MarginSpec="5 50 5 10" Flex="1" />
                                    </Items>
                                </ext:Container>
