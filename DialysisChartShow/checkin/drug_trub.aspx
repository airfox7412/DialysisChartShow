<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="drug_trub.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.drug_tube" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>血管通路用药维护</title>
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" Cls="x-grid-custom" Height="630">
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server" >
                                <Columns>
                                    ...
                                    <ext:Column ID="freq" runat="server" DataIndex="freq" Header="频率" Width="110">
                                        <Editor>
                                    ...
                                    <ext:Column ID="Column2" runat="server" Flex="1" />
                                </Columns>
                            </ColumnModel>
                            <BottomBar>
