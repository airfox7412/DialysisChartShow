<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_PreSet.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.Dialysis_PreSet" %>
...
<body>
    ...
    <div>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="border">
            <Items>
                <ext:Panel ID="Panel_Left" runat="server" Title="處方模板" Region="Center" Header="false" AutoScroll="true" Cls="Panellogo">
                    <Items>
                        <ext:Container ID="Container10" runat="server">
                            ...
                            <Items>
                                <ext:Panel ID="PanelT" runat="server" Region="West" AutoScroll="true" Resizable="false" Border="true">
                                    <Items>
                                        <ext:TreePanel ID="TreePanel1" runat="server" Header="false" Width="160" RootVisible="false" Height="650"> 
                                            <DirectEvents>
                                ...
                                <ext:Panel ID="PanelR" runat="server" Region="Center" Layout="FitLayout" Height="650" Width="1050">
                                    <Loader ID="Loader2" runat="server" Mode="Frame" ManuallyTriggered="true" AutoLoad="true" Url="Dialysis_PreSetView.aspx">
