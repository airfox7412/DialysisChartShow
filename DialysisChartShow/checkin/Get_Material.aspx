<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Get_Material.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.Get_Material" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items> 
                <ext:Panel ID="DetailPanel" runat="server" Title="库存表" Region="West" Collapsible="false" Header="false" AutoScroll="true" Width="350" Frame="true">
                    <Items>
                        <ext:GridPanel ID="GridPanel1" runat="server" Resizable="false" Cls="x-grid-custom">
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server" >
                                <Columns>
                                    ...
                                    <ext:Column ID="Column2" runat="server" DataIndex="pname" Header="耗材名称" Width="150" />
                        ...
                        <ext:GridPanel ID="GridPanel2" runat="server" Resizable="false" Cls="x-grid-custom-r" Height="600">
                            ...
                            <ColumnModel ID="ColumnModel2" runat="server" >
                                <Columns>
                                    ...
                                    <ext:Column ID="Column7" runat="server" DataIndex="ivpl_iv4" Header="肝素帽" Width="100" />
                                </Columns>
                            </ColumnModel>
                            <Plugins>
