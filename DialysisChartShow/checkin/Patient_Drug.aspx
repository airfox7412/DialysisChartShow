<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Patient_Drug.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.Patient_Drug" %>
                            ...
                            <ext:TabPanel ID="TabPanel1" runat="server" Width="1200" Height="770" UI="Primary">
                                <Items>                                    
                                    ...
                                    <ext:Panel ID="Panel_Long" runat="server" Title="长期医嘱" Icon="MedalGold1">
                                        <TabConfig ID="TabConfig1" runat="server" UI="Success" />
                                        <LayoutConfig>
                                            <ext:HBoxLayoutConfig Align="StretchMax" Pack="Center" />
                                        </LayoutConfig>
                                        <DirectEvents>
