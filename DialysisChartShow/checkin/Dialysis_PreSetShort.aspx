<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_PreSetShort.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.Dialysis_PreSetShort" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout">
            <Items>
                <ext:Panel ID="Panel_North" runat="server" Title="短期医嘱用药" Region="North" Header="false" AutoScroll="true">
                    <Items>
                        <ext:GridPanel ID="Grid_Short_Term" runat="server" Title="短期医嘱用药" Header="false" Frame="true" Height="650" Cls="x-grid-custom">
                            <TopBar>
                                <ext:Toolbar ID="Toolbar2" runat="server">
                                    <Items>
                                        ...
                                        <ext:Button ID="btnPrintS" runat="server" Icon="PrinterColor" IconAlign="Left" Text="打印" Padding="5" UI="Success">                                                                        
                                            <DirectEvents>
                            ...
                            <ColumnModel ID="ColumnModel2" runat="server">
                                <Columns>
                                    <ext:Column ID="Column9" runat="server" DataIndex="shord_id" Width="150" Hidden="true" />
                                    <ext:Column ID="Column4" runat="server" DataIndex="shord_dateord" Text="日期" Width="115" />  
                                    <ext:Column ID="Column5" runat="server" DataIndex="shord_timeord" Text="记录时间" Width="90" />
                                    <ext:Column ID="Column7" runat="server" DataIndex="shord_usr1" Text="经治医生" Width="90" />
                                    <ext:Column ID="Column8" runat="server" DataIndex="drug_name" Text="药品名称" Width="200" />
                                    <ext:Column ID="Column22" runat="server" DataIndex="shord_intake" Text="剂量" Width="110" />
                                    ...
                                    <ext:Column ID="Column18" runat="server" DataIndex="shord_dtactst" Text="停用日期" Width="130" />
