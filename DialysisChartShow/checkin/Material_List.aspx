<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Material_List.aspx.cs" Inherits="Dialysis_Chart_Show.checkin.Material_List" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="Panel_Left" runat="server" Title="领料" Region="Center" Header="false" AutoScroll="true" Cls="Panellogo">
                    <Items>
