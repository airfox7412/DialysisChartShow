<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_history_Hebei.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_history_Hebei" %>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="血液净化记录" ButtonAlign="Center" Padding="5" MonitorResize="true">
            <Items>
                ...
                <ext:Container ID="Container3739" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:TextField ID="TextField37" runat="server" FieldLabel="置换量" ReadOnly="true" IndicatorText="" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:TextField ID="TextField38" runat="server" FieldLabel="透析后凝血" ReadOnly="true" IndicatorText="" LabelWidth="130" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:SelectBox ID="SelectBox39" runat="server" FieldLabel="机器消毒时间" ReadOnly="true" LabelWidth="160" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1" />
                    </Items> 
                </ext:Container>
