...
{
    public partial class ipad_detaillist02_Suzhou : System.Web.UI.Page
    {
        ...
        protected void Show()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                //TextField2.Text = dt.Rows[0]["cln1_col11"].ToString(); //时间
                //TextField3.Text = dt.Rows[0]["cln1_col12"].ToString(); //历时
