<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_history_Alasamo.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_history_Alasamo" %>
            ...
            <Items>
                ...
                <ext:Container ID="Container1" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="cbo_mechine_model" runat="server" ColumnWidth=".5" FieldLabel="透析器型号" LabelWidth="160" Cls="Text-blue" LabelAlign="Right" LabelCls="my-Field" PaddingSpec="10 50 0 2" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                ...
                <ext:Container ID="Container4" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:TextField ID="TextField3" runat="server" FieldLabel="目标定容量" ColumnWidth=".5" IndicatorText="ml" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-red" LabelWidth="160" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-red'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                            <DirectEvents>
                ...
                <ext:Container ID="Container3739" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:TextField ID="TextField37" runat="server" FieldLabel="透前血压" ReadOnly="true" IndicatorText="mmhg" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:TextField ID="TextField38" runat="server" FieldLabel="/透后血压" ReadOnly="true" IndicatorText="mmhg" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:SelectBox ID="SelectBox39" runat="server" FieldLabel="血管通路情况" ReadOnly="true" LabelWidth="160" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1" />
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container21" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>          	    
                        <ext:TextField ID="TextField12" runat="server" FieldLabel="穿刺者" ReadOnly="true" LabelWidth="100" LabelAlign="Right" PaddingSpec="10 10 10 2" Cls="Text-blue" Flex="1">                            
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                        <ext:TextField ID="TextField13" runat="server" FieldLabel="上机者" ReadOnly="true" LabelWidth="80" LabelAlign="Right" PaddingSpec="10 10 10 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                        <ext:TextField ID="TextField131" runat="server" FieldLabel="核對者" ReadOnly="true" LabelWidth="80" LabelAlign="Right" PaddingSpec="10 10 10 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                        <ext:TextField ID="TextField24" runat="server" FieldLabel="下机者" ReadOnly="true" LabelWidth="80" LabelAlign="Right" PaddingSpec="10 50 10 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                ...
                <ext:Container ID="Container22" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:TextField ID="TextField14" runat="server" FieldLabel="用药核对护士" ReadOnly="true" LabelWidth="170" ColumnWidth=".34" LabelAlign="Right" PaddingSpec="10 50 10 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                        <ext:TextField ID="TextField25" runat="server" FieldLabel="用药护士" ReadOnly="true" LabelWidth="140" ColumnWidth=".32" LabelAlign="Right" PaddingSpec="10 50 10 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
