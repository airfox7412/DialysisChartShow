...
namespace Dialysis_Chart_Show
{
    ...
    public partial class ipad_index : System.Web.UI.Page
    {
        ...
        protected void RowSelect(object sender, DirectEventArgs e)
        {
            ...
            if (s != "")
            {
                string t = "ipad_checkin.aspx?pid=" + pid + "&floor=" + sFLOOR.Text + "&area=" + sAREA.Text + "&time=" + sTIME.Text + "&bedno=" + selRow[0]["BED_NO"] + "&daytyp=" + sWEEK.Text;
                X.Redirect(t);
            }
        }
