...
namespace Dialysis_Chart_Show.report {
    ...
    public class QualityEvaluation : ReportClass {
    ...
    public class CachedQualityEvaluation : Component, ICachedReport {

        public CachedQualityEvaluation()
        {
        }
