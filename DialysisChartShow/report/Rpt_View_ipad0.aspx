<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rpt_View_ipad0.aspx.cs" Inherits="Dialysis_Chart_Show.report.Rpt_View_ipad0" %>
...
<body>
    ...
    <div style="width: 1055px">
        ...
        <table border="0" style="width: 895px">
            <tr>
                <td class="style2">
                    <asp:Button ID="Button1" runat="server" Text="- Arterial pressure" CssClass="BtnAP" Width="300px" OnClick="Button1_Click" Height="40px" />
                </td>
                <td class="style1">
                    <asp:Button ID="Button2" runat="server" Text="- Dialysate pressure" CssClass="BtnDP" Width="300px" OnClick="Button2_Click" Height="40px" />
                </td>
                <td rowspan="2">
                    <asp:Button ID="Button5" runat="server" Text="- ALL" CssClass = "BtnAll" Width="300px" Height="80px" onclick="Button5_Click" />
                </td>
            </tr>
            <tr>
                <td class="style2">
                    <asp:Button ID="Button3" runat="server" Text="- Dialysate conductivity" CssClass="BtnDC" Width="300px" OnClick="Button3_Click" Height="40px" />
                </td>
                <td class="style1">
                    <asp:Button ID="Button4" runat="server" Text="- Venous pressure" CssClass="BtnVP" Width="300px" OnClick="Button4_Click" Height="40px" />
                </td>
            </tr>
        </table>
        <br />
