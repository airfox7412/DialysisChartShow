<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_0h_07.aspx.cs" Inherits="Dialysis_Chart_Show.Ipad.Dialysis_0h_07" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>预防跌倒护理措施评估表</title>
    <style type = "text/css">
    .mylabel1
    {
         font-weight:bold;  
                    ...
                    <Items>
                        <ext:Panel ID="Panel4" runat="server" Border="false" Header="false" ButtonAlign="Center">
                            ...
                            <Buttons>
                                ...
                                <ext:Button ID="btn_close" runat="server" Icon="Cancel" Text="关闭" Width="100">
                                    <DirectEvents>
