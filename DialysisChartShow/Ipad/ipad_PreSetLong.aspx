<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_PreSetLong.aspx.cs" Inherits="Dialysis_Chart_Show.ipad.ipad_PreSetLong" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout">
            <Items>
                <ext:Panel ID="Panel_North" runat="server" Title="长期医嘱用药" Region="North" Header="false" AutoScroll="true">
                    <Items>                        
                        <ext:GridPanel ID="Grid_Long_Term" runat="server" Title="长期医嘱用药" Header="false" Frame="true" Height="500" Cls="x-grid-custom">
                            <TopBar>
                                <ext:Toolbar ID="Toolbar3" runat="server">
                                    <Items>
                                        ...
                                        <ext:Button ID="btnPrintL" runat="server" Icon="PrinterColor" IconAlign="Left" Text="打印" Padding="5" UI="Success" Hidden="true"> 
                                            <DirectEvents>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    <ext:Column ID="Column1" runat="server" DataIndex="lgord_dateord" Text="日期" Width="100" />
                                    <ext:Column ID="Column2" runat="server" DataIndex="lgord_timeord" Text="记录时间" Width="70" />
                                    <ext:Column ID="Column6" runat="server" DataIndex="lgord_usr1" Text="经治医生" Width="70" />
                                    <ext:Column ID="Column10" runat="server" DataIndex="drug_name" Text="药品名称" Width="190" />
                                    <ext:Column ID="Column16" runat="server" DataIndex="lgord_intake" Text="剂量" Width="90" />
                                    ...
                                    <ext:Column ID="Column14" runat="server" DataIndex="lgord_dtactst" Text="停用日期" Width="100" />
