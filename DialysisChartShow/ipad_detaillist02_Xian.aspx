<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_detaillist02_Xian.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_detaillist02_Xian" %>
...
<body>
    ...
    <div>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="净化过程小结(西安武警)" BodyStyle="background-color:#EBF5FF !important;" AutoScroll="true">
            <Items>
                ...
                <ext:Container ID="Container2" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                            <ext:TextField ID="mechine_model" runat="server" FieldLabel="血管通路类型" LabelCls="formlabel" LabelAlign="Right" LabelWidth="220" 
                            ColumnWidth=".6" Cls="read_field" ReadOnly="true" />
                    </Items>
                </ext:Container>
                ...
                <ext:Container ID="Container31" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                            ...
                            ColumnWidth=".4" Cls="read_field" ReadOnly="true" />
                    </Items>
                </ext:Container>
                <ext:Container ID="Container32" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                            ...
                            ColumnWidth=".45" Cls="height" IndicatorText="(kg)" />
                    </Items>
                </ext:Container>
                <ext:Container ID="Container4" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                        <ext:TextField ID="TextField5" runat="server" FieldLabel="高压波动范围" LabelCls="formlabel" LabelAlign="Right" LabelWidth="220" ColumnWidth=".4" Cls="height"/>
                ...
                <ext:Container ID="Container5" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                        <ext:TextField ID="TextField7" runat="server" FieldLabel="低压波动范围" LabelCls="formlabel" LabelAlign="Right" LabelWidth="220" ColumnWidth=".4" Cls="height"/>
                        <ext:TextField ID="TextField8" runat="server" FieldLabel="~" LabelCls="formlabel" LabelAlign="Right" LabelWidth="10" ColumnWidth=".17" Cls="height" />
                    </Items>
                </ext:Container>
                ...
                <ext:Container ID="Container10" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                        <ext:TextArea ID="TextArea2" runat="server" FieldLabel="医生纪录" LabelCls="formlabel" ColumnWidth="1"
                ...
                <ext:Container ID="Container11" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>            
                        ...
                        <ext:TextField ID="TextField10" runat="server" AnchorHorizontal="100%" FieldLabel="用药护士" LabelCls="formlabel"
