<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ipad_detaillist_Alasamo.aspx.cs" Inherits="Dialysis_Chart_Show.ipad_detaillist_Alasamo" %>
            ...
            <Items>
                ...
                <ext:Container ID="Container12" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="cbo_mechine_model2" runat="server" ColumnWidth=".5" FieldLabel="透析器型号二" LabelWidth="160" Cls="Text-blue" LabelAlign="Right" LabelCls="my-Field" PaddingSpec="10 50 0 2" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox>
                ...
                <ext:Container ID="Container2" runat="server" FieldLabel="" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:SelectBox ID="cbo_Col24" runat="server" ColumnWidth=".5" FieldLabel="病情" LabelWidth="160" Cls="Text-blue" LabelAlign="Right" LabelCls="my-Field" PaddingSpec="10 50 0 2" Flex="1">
                            <Items>
                ...
                <ext:Container ID="Container6" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:TextField ID="TextField6" runat="server" FieldLabel="透析结束" ColumnWidth=".5" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" LabelWidth="160" ReadOnly="false" Flex="1" EmptyText="">
                            <Listeners>
                                <Blur Fn="StopTime" />
                            </Listeners>
                            <DirectEvents>
                ...
                <ext:Container ID="Container3739" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:TextField ID="TextField37" runat="server" FieldLabel="透前血压" IndicatorText="mmhg" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:TextField ID="TextField38" runat="server" FieldLabel="/透后血压" IndicatorText="mmhg" LabelWidth="110" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 0 0 10" Flex="1" />
                        <ext:SelectBox ID="SelectBox39" runat="server" FieldLabel="血管通路情况" LabelWidth="160" ColumnWidth=".3" LabelAlign="Right" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1" />
                    </Items> 
                </ext:Container>
                    ...
                    <Items>
                        ...
                        <ext:Container ID="Container25" runat="server" Layout="HBoxLayout">
                            <Items> 
                                ...
                                <ext:TextField ID="TextField_2" runat="server" FieldLabel="已超滤" LabelWidth="100" ColumnWidth=".34" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="ml" Flex="1" />
                            </Items> 
                        </ext:Container>
                ...
                <ext:GridPanel ID="Grid_Show_TPRBP" runat="server" Title="净化明细" ColumnWidth="1" Cls="x-grid-custom" RowLines="true" AutoScroll="true">
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="Column_3" runat="server" DataIndex="column_3" Text="已超滤" Width="80" />
