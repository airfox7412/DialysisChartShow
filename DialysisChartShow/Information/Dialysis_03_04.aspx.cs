...
{
    public partial class Dialysis_03_04 : BaseForm
    {
        private string _TableName = "zinfo_c_04";
        ...
        protected void Btn_Submit_Click(object sander, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_03_04.aspx?editmode=list");
        }
        ...
        private void ShowList()
        {
            ...
            string[] col_2 = { "服药方式", "opt_2" };
            string[] col_3 = { "口服", "opt_3" };
            string[] col_4 = { "其它请说明", "txt_4" };
            string[] col_5 = { "静脉", "opt_5" };
            string[] col_6 = { "其它请说明", "txt_6" };
            string[] col_7 = { "剂量", "num_7" };
            string[] col_8 = { "单位时间", "opt_8" };
            string[] col_9 = { "服药次数", "opt_9" };
            ...
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "活性维生素D列表");
        }
    }
}