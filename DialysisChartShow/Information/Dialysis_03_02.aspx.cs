...
{
    public partial class Dialysis_03_02 : BaseForm
    {
        private string _TableName = "zinfo_c_02";
        ...
        protected void Btn_Submit_Click(object sander, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_03_02.aspx?editmode=list");
        }
        ...
        private void ShowList()
        {
            ...
            string[] col_4 = { "方式", "opt_4" };
            string[] col_5 = { "剂量", "num_5" };
            string[] col_6 = { "单位时间", "opt_6" };
            string[] col_7 = { "用药次数", "opt_7" };
            ...
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "铁剂列表");
        }
    }
}