<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_04.aspx.cs" Inherits="Dialysis_Chart_Show.Information.Dialysis_04" %>
            ...
            <Items>
                <ext:Panel ID="PanelT" runat="server" Title="" Region="West" Width="200" MinWidth="200" MaxWidth="200" Split="true" Collapsible="false" >
                    <Items>
                        ...
                        <ext:Panel ID="TreePanel2Title" runat="server" Region="South" Width="200" MinWidth="200" MaxWidth="200" Split="true" Collapsible="true" Header="false" >
                            <Items>
                                <ext:TreePanel ID="TreePanel2" runat="server" Title="辅助检查" icon="ChartLine" Animate="true" RootVisible="false" Height="200">
                                    <DirectEvents>
                                        <ItemClick OnEvent="Node_Click">
                                            <ExtraParams>
                                                <ext:Parameter Name="rID" Value="record.data.id" Mode="Raw" />
