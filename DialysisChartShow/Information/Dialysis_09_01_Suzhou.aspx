<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_09_01_Suzhou.aspx.cs" Inherits="Dialysis_Chart_Show.Dialysis_09_01_Suzhou" %>
...
<body>
    ...
    <div>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" ButtonAlign="Center" Padding="5" MonitorResize="true" Title="血液净化记录(苏州医院)" BodyStyle="background-color:#EBF5FF !important;" >
            <Items>
                ...
                <ext:Container ID="Container10" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        ...
                        <ext:Checkbox ID="Checkbox1" BoxLabel="EPO" runat="server" ColumnWidth=".1" PaddingSpec="10 0 0 2" CheckedCls="CheckBox-red" Checked="false"/>
                        ...
                        <ext:Checkbox ID="Checkbox2" BoxLabel="左卡" runat="server" ColumnWidth=".1" PaddingSpec="10 0 0 2" CheckedCls="CheckBox-red" Checked="false"/>
                        <ext:TextField ID="TextCheckbox2" runat="server" ColumnWidth=".3" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" IndicatorText="g" Flex="1">
                            <Listeners>
                                <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:TextField>
                ...
                <ext:Container ID="Container11" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:Label ID="bb" runat="server" ColumnWidth=".15" Cls="label2" />
                        <ext:Checkbox ID="Checkbox3" runat="server" BoxLabel="钙剂" ColumnWidth=".13" CheckedCls="CheckBox-red" Checked="false" />
                        <ext:SelectBox ID="SelectCheckbox3" runat="server" FieldLabel="" LabelWidth="0" ColumnWidth=".3" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox> 
                        <ext:TextField ID="TextCheckbox3q" runat="server" FieldLabel="数量" LabelWidth="70" ColumnWidth=".2" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1" />
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container12" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:Label ID="cc" runat="server" ColumnWidth=".15" Cls="label2" />
                        <ext:Checkbox ID="Checkbox4" BoxLabel="稀释液" runat="server" ColumnWidth=".13" CheckedCls="CheckBox-red" Checked="false" />
                        <ext:SelectBox ID="SelectCheckbox4" runat="server" FieldLabel="" LabelWidth="0" ColumnWidth=".3" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox> 
                        <ext:TextField ID="TextCheckbox4q" runat="server" ColumnWidth=".17" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" FieldLabel="数量" LabelWidth="70" Flex="1" />
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container13" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:Label ID="Label15" runat="server" ColumnWidth=".15" Cls="label2" />
                        <ext:Checkbox ID="Checkbox5" BoxLabel="其它" runat="server" ColumnWidth=".1" CheckedCls="CheckBox-red" Checked="false" />
                        <ext:SelectBox ID="SelectCheckbox5" runat="server" FieldLabel="" LabelWidth="0" ColumnWidth=".3" LabelCls="my-Field" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <Listeners>
                                <Select Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                            </Listeners>
                        </ext:SelectBox> 
                        <ext:TextField ID="TextCheckbox5q" runat="server" ColumnWidth=".17" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" FieldLabel="数量" LabelWidth="70" Flex="1" />
                    </Items> 
                </ext:Container>
                ...
                <ext:Container ID="Container15" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                	    <ext:Label ID="Label8" runat="server" Text="深静脉置管:" ColumnWidth=".2" Cls="label2" />
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container16" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items> 
                        <ext:Label ID="Label9" runat="server" Text="" ColumnWidth=".36" Cls="label2" /> 
                        <ext:RadioGroup ID="RadioGroup1" runat="server" FieldLabel="1.穿刺部位" LabelCls="Radio-blue" LabelWidth="150" Flex="1">
                            <Items>
                                <ext:Radio ID="Radio11" runat="server" Name="Field11" InputValue="颈V" BoxLabel="颈V" CheckedCls="CheckBox-red" Checked="true" Flex="1" />
                                <ext:Radio ID="Radio12" runat="server" Name="Field11" InputValue="股V" BoxLabel="股V" CheckedCls="CheckBox-red" Flex="1" />
                                <ext:Radio ID="Radio13" runat="server" Name="Field11" InputValue="其他" BoxLabel="其他" CheckedCls="CheckBox-red" Flex="1" />
                                <ext:TextField ID="RField1" runat="server" ColumnWidth=".2" Cls="Text-blue" Flex="1">
                                    <Listeners>
                                        <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                                    </Listeners>
                                </ext:TextField>
                        		<ext:Label ID="RField11" runat="server" Text="" ColumnWidth=".1" Cls="label2" Flex="1" /> 
                            </Items>
                        </ext:RadioGroup>
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container17" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:Label ID="Label10" runat="server" Text="" ColumnWidth=".28" Cls="label2" /> 
                        <ext:RadioGroup ID="RadioGroup2" runat="server" FieldLabel="2.通畅情况" LabelCls="Radio-blue" LabelWidth="150" Flex="1">                           
                            <Items> 
                                <ext:Radio ID="Radio21" runat="server" Name="Field21" InputValue="是" BoxLabel="是" CheckedCls="CheckBox-red" Checked="true" Flex="1" />
                                <ext:Radio ID="Radio22" runat="server" Name="Field21" InputValue="否" BoxLabel="否" CheckedCls="CheckBox-red" Flex="1" />
                                <ext:TextField ID="RField2" runat="server" ColumnWidth=".2" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1">
                                    <Listeners>
                                        <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                                    </Listeners>
                                </ext:TextField>
                        		<ext:Label ID="RField21" runat="server" Text="" ColumnWidth=".1" Cls="label2" Flex="1" /> 
                            </Items>
                        </ext:RadioGroup>
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container18" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:Label ID="Label11" runat="server" Text="" ColumnWidth=".28" Cls="label2" /> 
                        <ext:RadioGroup ID="RadioGroup3" runat="server" FieldLabel="3.固定良好" LabelCls="Radio-blue" LabelWidth="150" Flex="1">                           
                            <Items> 
                                <ext:Radio ID="Radio31" runat="server" Name="Field31" InputValue="是" BoxLabel="是" CheckedCls="CheckBox-red" Checked="true" Flex="1" />
                                <ext:Radio ID="Radio32" runat="server" Name="Field31" InputValue="否" BoxLabel="否" CheckedCls="CheckBox-red" Flex="1" />
                                <ext:TextField ID="RField3" runat="server" ColumnWidth=".2" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1">
                                    <Listeners>
                                        <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                                    </Listeners>
                                </ext:TextField>
                        		<ext:Label ID="RField31" runat="server" Text="" ColumnWidth=".1" Cls="label2" Flex="1" /> 
                            </Items>
                        </ext:RadioGroup>
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container19" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:Label ID="Label12" runat="server" Text="" ColumnWidth=".3" Cls="label2" /> 
                        <ext:RadioGroup ID="RadioGroup4" runat="server" FieldLabel="4.局部皮肤" LabelCls="Radio-blue" LabelWidth="150" Flex="1">                           
                            <Items> 
                                <ext:Radio ID="Radio41" runat="server" Name="Field41" InputValue="正常" BoxLabel="正常" CheckedCls="CheckBox-red" Checked="true" Flex="1" />
                                <ext:Radio ID="Radio42" runat="server" Name="Field41" InputValue="异常" BoxLabel="异常" CheckedCls="CheckBox-red" Flex="1" />
                                <ext:TextField ID="RField4" runat="server" ColumnWidth=".2" Cls="Text-blue" PaddingSpec="10 50 0 2" Flex="1">
                                    <Listeners>
                                        <Change Handler="this.removeCls('Text-blue'); this.addCls('Text-black');" Single="true" />
                                    </Listeners>
                                </ext:TextField>
                        		<ext:Label ID="RField41" runat="server" Text="" ColumnWidth=".1" Cls="label2" Flex="1" /> 
                            </Items>
                        </ext:RadioGroup>
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container20" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:Label ID="Label13" runat="server" Text="" ColumnWidth=".24" Cls="label2" /> 
                        <ext:RadioGroup ID="RadioGroup5" runat="server" FieldLabel="内瘘通暢" LabelCls="Radio-black" LabelWidth="150" Flex="1">                           
                            <Items> 
                                <ext:Radio ID="Radio51" runat="server" Name="Field51" InputValue="是" BoxLabel="是" CheckedCls="CheckBox-red" Checked="true" Flex="1" />
                                <ext:Radio ID="Radio52" runat="server" Name="Field51" InputValue="否" BoxLabel="否" CheckedCls="CheckBox-red" Flex="1" />
                        		<ext:Label ID="RF51" runat="server" Text="" ColumnWidth=".1" Cls="label2" Flex="1" /> 
                        		<ext:Label ID="RF52" runat="server" Text="" ColumnWidth=".1" Cls="label2" Flex="1" /> 
                            </Items>
                        </ext:RadioGroup>
                    </Items> 
                </ext:Container>
                <ext:Container ID="Container21" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>          	    
                        <ext:TextField ID="TextField12" runat="server" FieldLabel="穿刺者" ReadOnly="true" LabelWidth="200" LabelAlign="Right" PaddingSpec="10 10 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                        ...
                        <ext:TextField ID="TextField13" runat="server" FieldLabel="上机者" ReadOnly="true" LabelWidth="200" LabelAlign="Right" PaddingSpec="10 10 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                        ...
                        <ext:TextField ID="TextField131" runat="server" FieldLabel="核對者" ReadOnly="true" LabelWidth="200" LabelAlign="Right" PaddingSpec="10 10 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                        ...
                        <ext:TextField ID="TextField24" runat="server" FieldLabel="下机者" ReadOnly="true" LabelWidth="200" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                ...
                <ext:Container ID="Container22" runat="server" AnchorHorizontal="100%" Layout="HBoxLayout">
                    <Items>
                        <ext:TextField ID="TextField14" runat="server" FieldLabel="用药核对护士" ReadOnly="true" LabelWidth="200" ColumnWidth=".34" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
                        ...
                        <ext:TextField ID="TextField25" runat="server" FieldLabel="用药护士" ReadOnly="true" LabelWidth="200" ColumnWidth=".32" LabelAlign="Right" PaddingSpec="10 50 0 2" Cls="Text-blue" Flex="1">
                            <DirectEvents>
                                <Focus OnEvent="text_click" />
                            </DirectEvents>
                            <Listeners>
