...
{
    public partial class Dialysis_02_06 : BaseForm
    {
        private string _TableName = "zinfo_b_06";
        ...
        protected void Btn_Submit_Click(object sander, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_02_06.aspx?editmode=list");
        }
        ...
        private void ShowList()
        {
            ...
            string[] col_1 = { "情况", "opt_1" };
            string[] col_2 = { "干体重", "num_2" };
            ...
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "干体重列表");
        }   
    }
}