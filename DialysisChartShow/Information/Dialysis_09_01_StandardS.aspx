<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_09_01_StandardS.aspx.cs" Inherits="Dialysis_Chart_Show.Dialysis_09_01_StandardS" %>
...
<body>
    ...
    <div>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="净化过程小结(标准版)" BodyStyle="background-color:#EBF5FF !important;" AutoScroll="true">
            <Items>
                ...
                <ext:Container ID="Container11" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>            
                        ...
                        <ext:TextField ID="TextField10" runat="server" AnchorHorizontal="100%" FieldLabel="巡视者" LabelCls="formlabel"
