<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_03_06.aspx.cs"
    Inherits="Dialysis_Chart_Show.Information.Dialysis_03_06" %>
...
<body>
    ...
    <div>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="Fit">
            <Items>
                <ext:FormPanel ID="FormPanel1" runat="server" Title="降磷药物" AutoScroll="true" ButtonAlign="Center">
                    <Items>
                            ...
                            <Items>
                                <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                    <Items>
                                        ...
                                        <ext:FieldSet ID="FieldSet2" runat="server" Flex="1" Title="降磷药物" Layout="AnchorLayout" Collapsible="true" Collapsed="true">
                                            <Defaults>
                                                <ext:Parameter Name="HideEmptyLabel" Value="false" Mode="Raw" />
                                            </Defaults>
                                            <Items>
                                                ...
                                                <ext:Radio ID="opt_2_1" runat="server" BoxLabel="碳酸钙" Name="opt_2" FieldLabel="种类" />
                                                <ext:Radio ID="opt_2_2" runat="server" BoxLabel="醋酸钙" Name="opt_2" />
                                                <ext:Radio ID="opt_2_3" runat="server" BoxLabel="其他钙剂" Name="opt_2" />
                                                <ext:Radio ID="opt_2_4" runat="server" BoxLabel="铝制剂" Name="opt_2" />
                                                <ext:Radio ID="opt_2_5" runat="server" BoxLabel="司维拉姆" Name="opt_2" />
                                                <ext:Radio ID="opt_2_6" runat="server" BoxLabel="碳酸镧" Name="opt_2" />
                                                <ext:Radio ID="opt_2_7" runat="server" BoxLabel="碳酸钙 + 维生素D" Name="opt_2" />
                                                <ext:Radio ID="opt_2_8" runat="server" BoxLabel="其它" Name="opt_2" />
                                                <ext:TextField ID="txt_3" runat="server" FieldLabel="其它请说明" />
                                                <ext:TextField ID="num_4" runat="server" FieldLabel="剂量" IndicatorText="mg" />
                                                ...
                                                <ext:Radio ID="opt_5_1" runat="server" BoxLabel="口服" Name="opt_5" FieldLabel="服药方式" />
