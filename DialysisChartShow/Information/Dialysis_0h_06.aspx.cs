...
{
    public partial class Dialysis_0h_06 : BaseForm
    {
        private string _TableName = "zinfo_h_06";
        ...
        protected void Btn_Submit_Click(object sender, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_0h_06.aspx?editmode=list");
        }

        protected void Btn_Print_Click(object sender, DirectEventArgs e)
        {
            X.Redirect("../report/Report_Dialysis_h.aspx?_PAT_ID=" + _PAT_ID + "&_INFO_DATE=" + _Request("sel_info_date") + "&_REPORT_NAME=96");
        }
        ...
        private void ShowList()
        {
            ...
            //string[] col_2 = { "总分", "txt_2" };
            //string[] col_3 = { "严重程度评分1", "txt_3" };
            //string[] col_4 = { "严重程度评分2", "txt_4" };
            //string[] col_5 = { "分布范围评分1", "txt_5" };
            //string[] col_6 = { "分布范围评分2", "txt_6" };
            //string[] col_7 = { "发作频率评分1", "txt_7" };
            //string[] col_8 = { "发作频率评分2", "txt_8" };
            //string[] col_9 = { "夜间睡眠障碍评分1", "txt_9" };
            //string[] col_10 = { "夜间睡眠障碍评分2", "txt_10" };
            //string[] col_11 = { "夜间睡眠障碍评分3", "txt_11" };
            //string[] col_12 = { "夜间睡眠障碍评分4", "txt_12" };
            ...
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "住院病人预防跌倒护理评估表");
        }
