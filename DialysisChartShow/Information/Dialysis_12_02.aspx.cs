...
{
    public partial class Dialysis_12_02 : BaseForm
    {
        private string _TableName = "dialysis_water2";
        ...
        protected void Btn_Submit_Click(object sander, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_12_02.aspx?editmode=list");
        }
        ...
        private void ShowList()
        {
            ...
            string[] col_1 = { "内毒素检测-透析液", "txt_11" };
            string[] col_2 = { "透析液描述",  "txt_12" };
            string[] col_3 = { "细菌检测-透析液", "txt_21" };
            string[] col_4 = { "透析液描述",  "txt_22" };            
            ...
            acol.Add(col_3);
            acol.Add(col_4);
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "透析液检测");
        }
    }
}