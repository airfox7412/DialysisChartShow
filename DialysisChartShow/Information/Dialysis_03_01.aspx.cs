...
{
    public partial class Dialysis_03_01 : BaseForm
    {
        private string _TableName = "zinfo_c_01";
        ...
        protected void Btn_Submit_Click(object sander, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_03_01.aspx?editmode=list");
        }
        ...
        private void ShowList()
        {
            ...
            string[] col_2 = { "种类", "opt_2" };
            string[] col_3 = { "国产", "opt_3" };
            string[] col_4 = { "其它国产促红素说明", "txt_4" };
            string[] col_5 = { "进口", "opt_5" };
            string[] col_6 = { "其它进口促红素说明", "txt_6" };
            string[] col_7 = { "给药方式", "opt_7" };
            string[] col_8 = { "单次剂量", "num_8" };
            string[] col_9 = { "单次剂量", "num_9" };
            string[] col_10 = { "用药次数", "opt_10" };
            string[] col_11 = { "单位时间", "opt_11" };
            ...
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "促红素列表");
        }
    }
}