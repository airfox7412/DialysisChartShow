<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_06_05_Alasamo.aspx.cs" Inherits="Dialysis_Chart_Show.Information.Dialysis_06_05_Alasamo" %>
                                ...
                                <ext:Panel ID="Panel4" runat="server" Border="false" Header="false">
                                    <Items>
                                        ...
                                        <ext:FieldSet ID="FieldSet11" runat="server" Flex="1" Title="入院诊断" Layout="AnchorLayout" Collapsible="true" Collapsed="false">
                                            ...
                                            <Items>
                                                <ext:TextArea ID="are_1" runat="server" FieldLabel="" LabelWidth="80" LabelAlign="Right" Width="1000" Height="100" />
                                                <ext:ComboBox ID="txt_1" runat="server" FieldLabel="医生" LabelWidth="80" LabelAlign="Right" ColumnWidth=".2" IndicatorText="*" IndicatorCls="Text-red" Cls="Text-blue"
