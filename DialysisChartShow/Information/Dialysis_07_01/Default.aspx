...
<div id="content">
	...
	<form id="form1" action="" method="post" enctype="multipart/form-data">
        ...
        <h2>病历上传作业</h2>
        <p>步骤一：点选"上传文件"。</p>
        <p>步骤二：在图档选择的视窗选取图档，图档命名条件："身分证_序号.JPG" 例：99999999_01.jpg。</p>
        <p>步骤三：在图档选择的视窗按"开启旧档"。</p>
		<div id="divSWFUploadUI">
			<div class="fieldset  flash" id="fsUploadProgress">
			<span class="legend">病历扫描</span>
			</div>
			<p>
				<span id="spanButtonPlaceholder"></span>
				<input id="btnCancel" type="button" value="" title="123" disabled="disabled"  />
				<br />
			</p>
		</div>
		<%--<noscript>
