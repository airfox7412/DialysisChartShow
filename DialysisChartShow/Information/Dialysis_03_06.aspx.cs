...
{
    public partial class Dialysis_03_06 : BaseForm
    {
        private string _TableName = "zinfo_c_06";
        ...
        protected void Btn_Submit_Click(object sander, DirectEventArgs e)
        {
            ...
            X.Redirect("Dialysis_03_06.aspx?editmode=list");
        ...
        private void ShowList()
        {
            ...
            string[] col_3 = { "其它请说明", "txt_3" };
            string[] col_4 = { "剂量", "num_4" };
            string[] col_5 = { "服药方式", "opt_5" };
            string[] col_6 = { "单位时间", "opt_6" };
            string[] col_7 = { "服药次数", "opt_7" };
            ...
            _Fill_Html_Table(_TableName, _PAT_ID, acol, "降磷药物列表");
        }
    }
}