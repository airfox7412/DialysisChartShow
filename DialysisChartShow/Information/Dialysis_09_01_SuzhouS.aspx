<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_09_01_SuzhouS.aspx.cs" Inherits="Dialysis_Chart_Show.Dialysis_09_01_SuzhouS" %>
...
<body>
    ...
    <div>
        ...
        <ext:FormPanel ID="FormPanel1" runat="server" Title="净化过程小结(苏州医院)" BodyStyle="background-color:#EBF5FF !important;" AutoScroll="true">
            <Items>
                ...
                <ext:Container ID="Container5" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                        <ext:TextField ID="TextField7" runat="server" FieldLabel="低压波动范" LabelCls="formlabel" LabelAlign="Right" LabelWidth="220" ColumnWidth="0.4" Cls="height"/>
                ...
                <ext:Container ID="Container9" runat="server" Layout="ColumnLayout" Padding="10">
                    <Items>
                        <ext:SelectBox ID="cbo_pressure" runat="server" FieldLabel="血压" LabelCls="formlabel" LabelAlign="Right" LabelWidth="180"
                ...
                <ext:Container ID="Container12" runat="server" Layout="ColumnLayout" Padding="20">
                    <Items> 
                        <ext:ImageButton ID="ImageBtn_save" runat="server" ImageUrl="~/Styles/save.png" Height="50" ColumnWidth="1" OverImageUrl="~/Styles/saveover.png">
                            <DirectEvents>
