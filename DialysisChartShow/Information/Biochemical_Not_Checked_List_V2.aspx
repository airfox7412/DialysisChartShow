<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Biochemical_Not_Checked_List_V2.aspx.cs"
    Inherits="Dialysis_Chart_Show.Information.Biochemical_Not_Checked_List_V2" %>
...
<body>
    ...
    <div>
        ...
        <ext:GridPanel ID="Grid_BioNotChecked_List" runat="server" Title="未检测名单" Height="550"
            Icon="ApplicationFormEdit" Cls="x-grid-custom" AutoScroll="True">
            <Store>
                <ext:Store ID="Store" runat="server">
                    <Model>
                        <ext:Model ID="Model" runat="server" Name="Checked_List" IDProperty="姓名">
                            <Fields>
                                ...
                                <ext:ModelField Name="项目3" Type="String" />
                                <ext:ModelField Name="项目4" Type="String" />
                                <ext:ModelField Name="项目5" Type="String" />
                            </Fields>
                        </ext:Model>
                    </Model>
                    <Reader>
            ...
            <ColumnModel ID="ColumnModel1" runat="server">
                <Columns>
                    ...
                    <ext:Column ID="Column03" runat="server" DataIndex="项目3" Text="项目3" Width="125" />
                    <ext:Column ID="Column04" runat="server" DataIndex="项目4" Text="项目4" Width="125" />
                    <ext:Column ID="Column05" runat="server" DataIndex="项目5" Text="项目5" Width="125" />
                </Columns>
            </ColumnModel>            
            <SelectionModel>
            ...
            <TopBar>
                <ext:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <ext:Button ID="ButtonSMS" runat="server" Text="Send SMS" Icon="TelePhoneGo">
                            <DirectEvents>
                                <Click OnEvent="sendSMS_Click" />
                            </DirectEvents>
                        </ext:Button>
