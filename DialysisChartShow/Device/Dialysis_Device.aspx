<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialysis_Device.aspx.cs" Inherits="Dialysis_Chart_Show.Device.Dialysis_Device" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                ...
                <ext:Panel ID="PanelR" runat="server" Region="Center" Layout="FitLayout" AnchorHorizontal="100%" AnchorVertical="100%">
                    <Loader ID="Loader1" runat="server" Mode="Frame" ManuallyTriggered="true" AutoLoad="true" Url="Dialysis_Device_01.aspx">
