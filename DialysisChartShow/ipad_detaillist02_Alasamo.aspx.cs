...
{
    public partial class ipad_detaillist02_Alasamo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!X.IsAjaxRequest)
            {
                ...
                //txt_htype.Text = Common.get_hp_name(Request.QueryString["hpack"]);
                ...
                if (patient_name.Text == null)
                {
                    ...
                    //txt_htype.Text = Common.get_hp_name(Request.QueryString["amp;hpack"]);
                    //hpack.Text = Request.QueryString["amp;hpack"];
        ...
        protected void Show()
        {
            ...
            string sql = "SELECT a.cln1_col11, a.cln1_col12, a.cln1_col34, a.cln1_col33, a.cln1_col35, a.cln1_col36, b.* FROM clinical1_nurse a ";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txt_htype.Text = dt.Rows[0]["cln1_col34"].ToString();
            }
            dt.Dispose();
        }
